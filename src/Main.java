...
public class Main {
    ...
    static void findFirstOdd() {
        List<Integer> ints = List.of(10, 32, 56, 7, 11, 88, 15, 76, 43, 30);
        List<Integer> intsNoOddNumbers = List.of(10, 32, 56, 10, 18, 88, 16, 76, 42, 30);
